...
!function(e){e(document).ready(function(){e("body").hasClass("home")&&(e(".hero-text-slider").slick({autoplay:!0,autoplaySpeed:3e3,arrows:!1,dots:!1,fade:!0,speed:1e3}),e(".team-slider").slick({arrows:!0,dots:!1}),function(){var a=e(".home-projects");e(".projects").slick({arrows:!1,dots:!1,fade:!0,speed:500,responsive:[{breakpoint:768,settings:{adaptiveHeight:!0}}]}),e('[data-action="project-tab"]').on("click",function(t){t.preventDefault(),a.find(".tab").not(this).removeClass("active"),e(this).addClass("active"),e(".projects").slick("slickGoTo",e(this).index())})}(),e(".news-slider").slick({arrows:!0,dots:!1})),e(".gallery").magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(e){return e.el.attr("title")}}})})}(jQuery);